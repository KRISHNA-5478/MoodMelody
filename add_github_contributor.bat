@echo off
REM This script adds a GitHub contributor to the repository history
REM Usage: add_github_contributor.bat GithubUsername RealName email@example.com
...
:usage
echo Usage: %0 GithubUsername RealName email@example.com
exit /B 1